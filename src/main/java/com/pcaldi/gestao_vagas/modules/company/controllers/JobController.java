...
import com.pcaldi.gestao_vagas.modules.company.dto.CreateJobDTO;
import com.pcaldi.gestao_vagas.modules.company.entities.JobEntity;
import com.pcaldi.gestao_vagas.modules.company.useCases.CreateJobUseCase;
...
public class JobController {
    ...
    @Operation(summary = "Cadastro de vagas", description = "Responsável por cadastrar novas vagas.")
    @ApiResponses({
